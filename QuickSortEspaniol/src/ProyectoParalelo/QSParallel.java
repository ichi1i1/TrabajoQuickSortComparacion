...
public class QSParallel implements Runnable {
    ...
    public void run() {
        quickSort(this.datos, this.inicio, this.fin);
    }
    ...
    public static void main(String[] args) {
        ...
        int s = particion(datos, 0, datos.length - 1);

        // Crear y lanzar dos hilos para ordenar las dos mitades en paralelo
        Thread t1 = new Thread(new QSParallel(datos, 0, s - 1));
        Thread t2 = new Thread(new QSParallel(datos, s + 1, datos.length - 1));
